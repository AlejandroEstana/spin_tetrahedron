...
function initial_state(is_sparse,Bond_irrep,Tetrahedral_irrep,D,init_statenm=nothing,init_noise=0)
...
function construct_su2_PG_IPESS(json_dict,A_set,E_set, S_label, Sz_label, virtual_particle)
